window.onload = function () {
		...
		var clone = elem.childNodes[1].cloneNode(true); //take cpanel-item
                
		var icon = document.createElement("i");
		icon.setAttribute("class", "fa fa-times-circle");
		
		clone.childNodes[1].childNodes[3].appendChild(icon); //append icon 
		
		var id = clone.childNodes[1].childNodes[3].childNodes[1].id;  
		
	 	elem.appendChild(clone); //append new cpanel to the DOM
	...
	var index=0; //this index tracks number of triggered events for destination
